#!/bin/bash
# ==============================================================================
# FEDORA AUTO-DEPLOYMENT SCRIPT (WITH FASTFETCH)
...
# Update and Install Packages (Fedora)
...
# Fastfetch Startup with blue theme
...
setopt HIST_IGNORE_DUPS HIST_IGNORE_SPACE autocd correct unsetopt PROMPT_SP
...
echo -e "\n===  ^=^t^q FEDORA ENVIRONMENT (W/ FASTFETCH) DEPLOYED SUCCESSFULLY ==="
PAYLOAD_EOF
